...
case $DONGLE in
    16)
        PRIVATE_KEY="IM4U6PeB/PVq8eJht1ZWXCVytqzoYv0JY/LTrqCKen4="
        ADDRESS="10.8.0.32/24"
        ;;
    17)
        PRIVATE_KEY="qEC35bLGr8Ox4i/mUnVVFCt5K7YjNQ1ubcZAQM8pSEI="
        ADDRESS="10.8.0.34/24"
        ;;
    18)
        PRIVATE_KEY="6JLiO3n0ye8K3FaqUlBE4qaKNUKHgD4dLiNSI2VTX3c="
        ADDRESS="10.8.0.36/24"
        ;;
    19)
        PRIVATE_KEY="mOLtD4LMauZXgemTTXeq9yRtYxJ1W7N3r/RxAhEwHUQ="
        ADDRESS="10.8.0.38/24"
        ;;
    20)
        PRIVATE_KEY="iDBPvOktaM1Vh8Fjb6v5XUF2orqPImYJxPI9pX0zBnM="
        ADDRESS="10.8.0.40/24"
        ;;
    21)
        PRIVATE_KEY="KBdYfEPhuiAs1ziMmyoaI3999dIC5dssDgW3blPh42E="
        ADDRESS="10.8.0.42/24"
        ;;
    22)
        PRIVATE_KEY="EHNrRdLJSep3NaJAf6Ra2iC4UMP6OakYhvASG/+vRVA="
        ADDRESS="10.8.0.44/24"
        ;;
    23)
        PRIVATE_KEY="mHlJla6VQZMRhXKWVp4rYJyROAtOkOIOlnMyVJMu9XA="
...
[Peer]
PublicKey = PXcOM8fwfOU1IyP0uXduprYunXTK5XzdmUceagJZLSc=
Endpoint = 112.161.54.7:55555
